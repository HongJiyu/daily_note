...
![image-20210113230631976](E:\0git_note\mysql\mysql技术内幕\image\image-20210113230631976.png)
...
![image-20210113230808519](E:\0git_note\mysql\mysql技术内幕\image\image-20210113230808519.png)
...
![image-20210114224039962](E:\0git_note\mysql\mysql技术内幕\image\image-20210114224039962.png)
...
- 将查询到的辅助索引键值存放于缓存，缓存的数据是根据辅助索引键值排序的。
- 将键值根据rowID进行排序
- 根据rowID排序顺序访问实际数据文件。
